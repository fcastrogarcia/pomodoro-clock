...
const SessionLength = (props) => (
  <Fragment>
      <Card style={styles.lengthCard}>
        <CardActions>
          <IconButton onClick={props.handleSession(props.decrementValue)}><RemoveRoundedIcon  /></IconButton>
          <Display length={props.length} />
          <IconButton onClick={props.handleSession(props.incrementValue)}><AddRoundedIcon /></IconButton>
        </CardActions>
      </Card>
  </Fragment>
)
