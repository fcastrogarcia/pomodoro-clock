...
class App extends Component {
  ...
  handleBreak = value => () => {
    this.setState({
      breakLength:
        this.state.breakLength === 1 && value === "break-decrement"
          ? this.state.breakLength
          : value === "break-decrement"
          ? this.state.breakLength - 1
          : this.state.breakLength === 60 && value === "break-increment"
          ? this.state.breakLength
          : this.state.breakLength + 1
    });
  };
  ...
  breakTimer() {
    this.setState({
      breakTime: true,
      breakLeft: !this.state.breakTime
          ...
          <div style={styles.upperContainer}>
            <div style={styles.lengthCardContainer}>
              ...
              <BreakLength
                ...
                decrementValue="break-decrement"
                incrementValue="break-increment"
              />
            </div>
            <div style={styles.lengthCardContainer}>
              ...
              <SessionLength
                ...
                decrementValue="session-decrement"
                incrementValue="session-increment"
              />
            </div>
          </div>
          <div>
